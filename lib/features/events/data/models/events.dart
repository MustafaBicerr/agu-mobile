class Events {
  ...
  Events.fromJson(Map<String, dynamic> json) {
    kulup = json["kulup"] ?? json["kulup_adi"];
...
class Trip {
  ...
  Trip.fromJson(Map<String, dynamic> json) {
    ...
    etkinlik_adi = json["etkinlik_adi"]?.toString();
    saat1 = s(json["saat1"]);
    konum1 = json["konum1"]?.toString();
    aciklama1 = json["aciklama1"]?.toString();
    saat2 = s(json["saat2"]);
    konum2 = json["konum2"]?.toString();
    aciklama2 = json["aciklama2"]?.toString();
    saat3 = s(json["saat3"]);
    konum3 = json["konum3"]?.toString();
    aciklama3 = json["aciklama3"]?.toString();
    saat4 = s(json["saat4"]);
    konum4 = json["konum4"]?.toString();
    aciklama4 = json["aciklama4"]?.toString();
    saat5 = s(json["saat5"]);
    konum5 = json["konum5"]?.toString();
    aciklama5 = json["aciklama5"]?.toString();
  }
