                      ...
                      return Column(
                        ...
                        children: [
                          ...
                          _buildMealCard(
                            ...
                            imageUrl:
                                _mealList.value[todayIdx].vegetarianImageUrl,
                          ...
                          _buildMealCard(
                            ...
                            imageUrl:
                                _mealList.value[todayIdx].helperMealImageUrl,
                          ...
                          _buildMealCard(
                            mealType: '5_dessert',
                            icon: Icons.cake,
                            imageUrl: _mealList.value[todayIdx].dessertImageUrl,
...
class _MealCardState extends State<MealCard> {
  ...
  Widget _buildMealVisual() {
    if (_isValidHttpUrl(widget.imageUrl)) {
      return ClipRRect(
        borderRadius: BorderRadius.circular(12),
        child: Image.network(
          widget.imageUrl!,
