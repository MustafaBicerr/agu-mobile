...
class _MyAppState extends State<MyApp> {
  ...
  @override
  void initState() {          //initState değişicek
  ...
  void goToDetail(Lesson lesson) async { // bunun için route kullanıccaz fonksiyon yazmaya gerek yok
  ...
  void goToLessonAdd() async {    // bunun için route kullanıccaz fonksiyon yazmaya gerek yok
    var result = await Navigator.push(
      context,
